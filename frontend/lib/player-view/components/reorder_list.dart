...
/// The callback used by [MyReorderableListView] to move an item to a new
/// position in a list.
///
...
/// [MyReorderableListView] will need to account for this when inserting before
/// [newIndex].
///
...
class MyReorderableListView extends StatefulWidget {
  ...
  /// underlying list.
  ///
  /// This [MyReorderableListView] calls [onReorder] after a list child is dropped
  /// into a new position.
...
class _ReorderableListContentState extends State<_ReorderableListContent> with TickerProviderStateMixin<_ReorderableListContent> {
  ...
  static const double _defaultDropAreaExtent = 50.0;
  ...
  void _scrollTo(BuildContext context) {
    ...
    print((viewport.getOffsetToReveal(contextObject, 0.0).offset - margin));
