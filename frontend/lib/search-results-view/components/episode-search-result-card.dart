...
class EpisodeSearchResultCard extends StatelessWidget {
  static const double HEIGHT =
      CARD_HEIGHT + TOP_MARGIN + DESCRIPTION_TOP_MARGIN;

  static const double CARD_HEIGHT = 103;
  static const double LEFT_MARGIN = 10;
  static const double TOP_MARGIN = 10;

  static const double BUTTON_SIDE_WIDTH =
      2 * CustomIconButton.SQUARE_DIMENSIONS + 3 * BUTTON_BETWEEN_SPACING;
        ...
        child: Column(
          ...
          children: [
            Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Expanded(
                  //container with all the text (left side of card)
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                    Container(
              ...
              Container(
                // container with the buttons (right)
                ...
                child: Consumer<QueueService>(
                  builder: (context, queueService, child) {
                    return Row(
                      ...
                      children: [
                        CustomIconButton(icon: Icons.play_arrow_rounded),
                        SizedBox(
