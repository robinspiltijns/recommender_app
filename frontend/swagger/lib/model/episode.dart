...
/* Edit url of this episode where you can update the audio url if you find the audio is broken. */
  ...
  @override
  String toString() {
    return 'Episode[id=$id, link=$link, audio=$audio, image=$image, title=$title, podcast=$podcast, thumbnail=$thumbnail, description=$description, pubDateMs=$pubDateMs, listennotesUrl=$listennotesUrl, audioLengthSec=$audioLengthSec, explicitContent=$explicitContent, maybeAudioInvalid=$maybeAudioInvalid, listennotesEditUrl=$listennotesEditUrl, ]';
  }
  ...
  Episode.fromJson(Map<String, dynamic> json) {
    ...
    image = json['image'];
    title = json['title'];
    podcast = new Show.fromJson(json['podcast']);
