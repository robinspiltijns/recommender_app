...
class DefaultApi {
  ...
  Future<BestPodcastsResponse> getBestOfGenre(String genreId) async {
    ...
    if(genreId == null) {
     throw new ApiException(400, "Missing required param: genreId");
    }

    // create path and map variables
    String path = "best-of-genre".replaceAll("{format}","json");

    // query params
    List<QueryParam> queryParams = [];
    Map<String, String> headerParams = {};
    Map<String, String> formParams = {};
      queryParams.addAll(_convertParametersForCollectionFormat("", "genreId", genreId));
  ...
  Future<EpisodeFull> getEpisode(String id) async {
    ...
    // create path and map variables
    String path = "episode".replaceAll("{format}","json");
  ...
  Future<GetEpisodeRecommendationsResponse> getEpisodeRecommendationsBasedOnEpisode(String id) async {
    ...
    // create path and map variables
    String path = "get-recommendations-based-on/episode".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'GetEpisodeRecommendationsResponse') as GetEpisodeRecommendationsResponse ;
    } else {
      return null;
    }
  }
  ...
  Future<GetGenresResponse> getGenres() async {
    ...
    // create path and map variables
    String path = "genres".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'GetGenresResponse') as GetGenresResponse ;
    } else {
      return null;
    }
  }
  ...
  Future<GetPodcastRecommendationsResponse> getPodcastRecommendationsBasedOnPodcast(String id) async {
    ...
    // create path and map variables
    String path = "get-recommendations-based-on/podcast".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'GetPodcastRecommendationsResponse') as GetPodcastRecommendationsResponse ;
    } else {
      return null;
    }
  }
  ...
  Future<SearchResult> getSearchResults(String queryString, String searchField) async {
    ...
    // verify required params are set
    if(queryString == null) {
     throw new ApiException(400, "Missing required param: queryString");
    }
    if(searchField == null) {
     throw new ApiException(400, "Missing required param: searchField");
    }
    ...
    Map<String, String> headerParams = {};
    Map<String, String> formParams = {};
      queryParams.addAll(_convertParametersForCollectionFormat("", "queryString", queryString));
      queryParams.addAll(_convertParametersForCollectionFormat("", "searchField", searchField));
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'SearchResult') as SearchResult ;
    } else {
      return null;
    }
  }
  ...
  Future<TimingResults> getTimingResults() async {
    Object postBody = null;

    // verify required params are set

    // create path and map variables
    String path = "timing-results".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'TimingResults') as TimingResults ;
    } else {
      return null;
    }
  }
  ...
  Future<GetGenresResponse> getTopLevelGenres() async {
    Object postBody = null;

    // verify required params are set

    // create path and map variables
    String path = "top-level-genres".replaceAll("{format}","json");
  ...
  Future getUniqueId() async {
    ...
    // create path and map variables
    String path = "get-unique-id".replaceAll("{format}","json");
  ...
  ///
  /// 
  Future logTimingResultPost({ TimingResult body }) async {
    Object postBody = body;

    // verify required params are set

    // create path and map variables
    String path = "log-timing-result".replaceAll("{format}","json");
